  ...
  switch (type) {
    case SearchingAlgoEnum.DIJKSTRA:
      return {
        ...
        referenceLink: `https://takeuforward.org/data-structure/g-35-print-shortest-path-dijkstras-algorithm/`,
    ...
    case SearchingAlgoEnum.BFS:
      return {
        ...
        guaranteedShortedPath: true,
        referenceLink: `https://takeuforward.org/graph/breadth-first-search-bfs-level-order-traversal/`,
        gif: `/assets/bfs.gif`,
      };
    case SearchingAlgoEnum.DFS:
      return {
        ...
        referenceLink: `https://takeuforward.org/data-structure/depth-first-search-dfs/`,
        gif: `/assets/dfs.gif`,
      };
